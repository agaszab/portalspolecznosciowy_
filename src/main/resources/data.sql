...
insert into user (username, password, enabled, first_name, last_name, email, img) values ('ania', '$2a$10$9SjNyDaTpPR7EhBf51ERH.m8pk.PNPouXQSMpNK28wS0F6wHg7vR6', true, 'Marysia', 'Zawada', 'jakis@mail.pl', 'https://png.icons8.com/color/1600/circled-user-female-skin-type-1-2.png');
