insert into user (username, password, enabled, first_name, last_name, email) values ('admin', '$2a$10$Pu2BzhYFCasFG4ddvJUjS.CjsnZomjiIX5Hj6jMvTWErSgiYsqFS.', true, 'Jan', 'Kowalski', 'jan@kowalski.pl');
...
insert into user (username, password, enabled, first_name, last_name, email) values ('asia','$2a$10$9SjNyDaTpPR7EhBf51ERH.m8pk.PNPouXQSMpNK28wS0F6wHg7vR6', true, 'Asia', 'Słowik', 'jakis@mail.pl');
